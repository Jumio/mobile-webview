...
package com.jumio.datefinderdl.java;
...
import com.google.firebase.samples.apps.mlkit.java.facedetection.*;
import com.google.firebase.samples.apps.mlkit.java.textrecognition.passport.PassportTextRecognitionProcessor;
import com.google.firebase.samples.apps.mlkit.java.textrecognition.regular.TextRecognitionProcessor;
...
public final class LivePreviewActivity extends AppCompatActivity
    ...
    private static final String PASSPORT_TEXT_DETECTION = "Passport Text Detection";
    ...
    private String selectedModel = FACE_DETECTION;  // change
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        options.add(PASSPORT_TEXT_DETECTION);
        ...
        try {
            switch (model) {
                case TEXT_DETECTION:
                    ...
                    break;
                case PASSPORT_TEXT_DETECTION:
                    Log.i(TAG, "Using Text Detector Processor");
                    cameraSource.setMachineLearningFrameProcessor(new PassportTextRecognitionProcessor());
                    break;
                case FACE_DETECTION:
